    ...
    $('.room-slider').slick({
	  ...
	  adaptiveHeight: true,
		...
		$(function() {
			...
			// $('.slider-troef__item').matchHeight();
		});
		...
		// });
			...
			// 		$('.slider-troef__blocks').slick('resize');
			// 	});
			// });
...
(function( $ ) {
  ...
  $('.footer-tabs').on("click", ".footer-tabs__tabs-title", function() {
	...
	// if ($(window).width() <= 575 ) {
	// 	$(".container-menu__title,.footer-tabs__wrapper").click(function(){
	// 	var target = $(this).parent().children(".container-menu__menu-footer, .nav__menu-list, .socials, .footer-tabs__wrapper ");
	// 	$(target).slideToggle();
	// 	});

	// 	$(".container-menu__title,.nav__title, .footer-menu__navigation-title, .footer-tabs__tabs-title").click(function () {
